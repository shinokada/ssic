fn_svg_path() {
  ...
  for file in *; do
    ...
    cp "${script_dir}/src/flags/v2/flags-v2.txt" "${SVELTENAME}"
...
fn_flag() {
  ...
  CURRENTDIR="${LOCAL_REPO_NAME}/${SVELTE_LIB_DIR}"
    ...
    cp "${script_dir}/src/flags/v2/Icon.svelte" "${CURRENTDIR}/Icon.svelte"
    cp "${script_dir}/src/flags/v2/types.txt" "${CURRENTDIR}/types.ts"
