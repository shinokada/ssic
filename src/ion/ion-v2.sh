fn_svg_path() {
  ...
  for file in *; do
    ...
    cp "${script_dir}/src/ion/ion-v2-template.txt" "${SVELTENAME}"
...
fn_ion() {
  ...
  cp "${script_dir}/src/ion/Icon.svelte" "${CURRENTDIR}/Icon.svelte"
  cp "${script_dir}/src/ion/ion-v2-types.txt" "${CURRENTDIR}/types.ts"
