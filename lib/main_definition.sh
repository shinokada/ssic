...
parser_definition() {
    ...
    cmd animate-ion -- "Create animate ion icons."
    cmd animate-flowbite -- "Create animate flowbite icons."
    cmd animate-hero -- "Create animate heroicons."
    cmd animate-radix -- "Create animate radix icons."
